...
CREATE TABLE IF NOT EXISTS "product_customizations" (
	...
	"class_prefix" text,
	"product_id" uuid NOT NULL,
	"location_message" text DEFAULT 'Hey! It looks like you are from <b>{country}</b>. We support Parity Purchasing Power pricing. so if you need it, use code <b>''{coupon}''</b> to get a <b>{discount</b>} off.' NOT NULL,
